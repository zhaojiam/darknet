...
void scale_bias_gpu(float *output, float *biases, int batch, int n, int size)
{
    ...
    */
    ...
    /*
    DPCT1010:69: SYCL uses exceptions to report errors and does not use the
...
void backward_scale_gpu(float *x_norm, float *delta, int batch, int n, int size, float *scale_updates)
{
    ...
    */
    dpct::get_in_order_queue().submit([&](sycl::handler &cgh) {
        /*
        DPCT1101:157: 'BLOCK' expression was replaced with a value. Modify the
    ...
    /*
    DPCT1010:71: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
void add_bias_gpu(float *output, float *biases, int batch, int n, int size)
{
    ...
    */
    ...
    /*
    DPCT1010:72: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
void backward_bias_gpu(float *bias_updates, float *delta, int batch, int n, int size)
{
    if(size == 1){
        ...
        */
        dpct::get_in_order_queue().submit([&](sycl::handler &cgh) {
            /*
            DPCT1101:158: 'BLOCK' expression was replaced with a value. Modify
...
extern "C" void adam_gpu(int n, float *x, float *m, float *v, float B1, float B2, float rate, float eps, int t)
{
    ...
    */
    ...
    /*
    DPCT1010:75: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void normalize_delta_gpu(float *x, float *mean, float *variance, float *mean_delta, float *variance_delta, int batch, int filters, int spatial, float *delta)
{
    ...
    */
    ...
    /*
    DPCT1010:76: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void fast_mean_delta_gpu(float *delta, float *variance, int batch, int filters, int spatial, float *mean_delta)
{
    ...
    */
    dpct::get_in_order_queue().submit([&](sycl::handler &cgh) {
        /*
        DPCT1101:159: 'threads' expression was replaced with a value. Modify the
        code to use the original expression, provided in comments, if it is
        correct.
        */
    ...
    /*
    DPCT1010:80: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void fast_variance_delta_gpu(float *x, float *delta, float *mean, float *variance, int batch, int filters, int spatial, float *variance_delta)
{
    ...
    */
    dpct::get_in_order_queue().submit([&](sycl::handler &cgh) {
        /*
        DPCT1101:160: 'threads' expression was replaced with a value. Modify the
        code to use the original expression, provided in comments, if it is
        correct.
        */
        sycl::local_accessor<float, 1> local_acc_ct1(
...
extern "C" void l2normalize_gpu(float *x, float *dx, int batch, int filters, int spatial)
{
    ...
    */
    ...
    /*
    DPCT1010:83: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void fast_mean_gpu(float *x, int batch, int filters, int spatial, float *mean)
{
    ...
    */
    dpct::get_in_order_queue().submit([&](sycl::handler &cgh) {
        /*
        DPCT1101:161: 'threads' expression was replaced with a value. Modify the
        code to use the original expression, provided in comments, if it is
        correct.
        */
        sycl::local_accessor<float, 1> local_acc_ct1(
    ...
    /*
    DPCT1010:86: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void fast_variance_gpu(float *x, float *mean, int batch, int filters, int spatial, float *variance)
{
    ...
    */
    dpct::get_in_order_queue().submit([&](sycl::handler &cgh) {
        /*
        DPCT1101:162: 'threads' expression was replaced with a value. Modify the
        code to use the original expression, provided in comments, if it is
        correct.
        */
        sycl::local_accessor<float, 1> local_acc_ct1(
...
extern "C" void mul_gpu(int N, float * X, int INCX, float * Y, int INCY)
{
    ...
    */
    ...
    /*
    DPCT1010:92: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
