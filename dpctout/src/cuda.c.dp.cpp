...
void cuda_set_device(int n) try {
    gpu_index = n;
    /*
    DPCT1093:0: The "n" device may be not the one intended for use. Adjust the
...
void check_error(dpct::err0 status)
{
    ...
    */
    ...
    {
        /*
        DPCT1009:6: SYCL uses exceptions to report errors and does not use the
    ...
    */
    ...
    {
        /*
        DPCT1009:7: SYCL uses exceptions to report errors and does not use the
        error codes. The call was replaced by a placeholder string. You need to
        rewrite this code.
        */
        const char *s = "<Placeholder string>";
