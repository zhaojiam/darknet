...
void add_bias_gpu(float *output, float *biases, int batch, int n, int size)
{
    ...
    /*
    DPCT1010:11: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
void backward_bias_gpu(float *bias_updates, float *delta, int batch, int n, int size)
{
    ...
    /*
    DPCT1010:12: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void normalize_delta_gpu(float *x, float *mean, float *variance, float *mean_delta, float *variance_delta, int batch, int filters, int spatial, float *delta)
{
    ...
    /*
    DPCT1010:14: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void fast_variance_gpu(float *x, float *mean, int batch, int filters, int spatial, float *variance)
{
    ...
    /*
    DPCT1010:21: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void flatten_gpu(float *x, int spatial, int layers, int batch, int forward, float *out)
{
    ...
    /*
    DPCT1010:28: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void scal_gpu(int N, float ALPHA, float * X, int INCX)
{
    ...
    /*
    DPCT1010:35: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void shortcut_gpu(int batch, int w1, int h1, int c1, float *add, int w2, int h2, int c2, float s1, float s2, float *out)
{
    ...
    /*
    DPCT1010:38: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void smooth_l1_gpu(int n, float *pred, float *truth, float *delta, float *error)
{
    ...
    /*
    DPCT1010:39: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void logistic_x_ent_gpu(int n, float *pred, float *truth, float *delta, float *error)
{
    ...
    /*
    DPCT1010:41: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void l1_gpu(int n, float *pred, float *truth, float *delta, float *error)
{
    ...
    /*
    DPCT1010:43: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void deinter_gpu(int NX, float *X, int NY, float *Y, int B, float *OUT)
{
    ...
    /*
    DPCT1010:45: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void inter_gpu(int NX, float *X, int NY, float *Y, int B, float *OUT)
{
    ...
    /*
    DPCT1010:46: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void weighted_sum_gpu(float *a, float *b, float *s, int num, float *c)
{
    ...
    /*
    DPCT1010:47: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void weighted_delta_gpu(float *a, float *b, float *s, float *da, float *db, float *ds, int num, float *dc)
{
    ...
    /*
    DPCT1010:48: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
}
...
extern "C" void softmax_tree(float *input, int spatial, int batch, int stride, float temp, float *output, tree hier)
{
    ...
    /*
    DPCT1010:50: SYCL uses exceptions to report errors and does not use the
    error codes. The call was replaced with 0. You need to rewrite this code.
    */
    check_error(0);
